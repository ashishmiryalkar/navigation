...
def generate_launch_description():
    ...
    controller_yaml = os.path.join(get_package_share_directory('path_planner'), 'config', 'controller.yaml')
    ...
    recovery_yaml = os.path.join(get_package_share_directory('path_planner'), 'config', 'recovery.yaml')
